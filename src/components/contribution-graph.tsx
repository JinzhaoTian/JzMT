        ...
        <TooltipProvider delayDuration={0}>
            <div className="border rounded-sm p-4 pt-2">
                <div className="grid grid-flow-col grid-rows-[auto, repeat(8,_10px)] grid-cols-[auto, repeat(54,_10px)] gap-1">
                    ...
                    <div className="grid grid-cols-[repeat(53, _10px)] grid-rows-[repeat(1,_10px)] gap-1 col-span-53 row-span-1 pb-1">
                        {contributions.map((data, index) => {
                            ...
                            if (
                                ...
                                return (
                                    <span
                                        key={`month-${index}`}
                                        className={`text-[10px] text-left col-start-${col} row-start-1`}
                                    >
                            ...
                            return (
                                <Tooltip key={index}>
                                    ...
                                    <TooltipContent side="top">
                                        <p>{`${contributions} contributions on ${time}.`}</p>
                                    </TooltipContent>
                                </Tooltip>
                            );
                        })}
